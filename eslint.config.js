export default [
  ...
  },
  {
    ...
    rules: {
      ...import('eslint-plugin-react').configs.recommended.rules,
      ...import('eslint-plugin-react-hooks').configs.recommended.rules,
      ...import('@typescript-eslint/eslint-plugin').configs.recommended.rules,
      ...import('eslint-plugin-prettier').configs.recommended.rules,
